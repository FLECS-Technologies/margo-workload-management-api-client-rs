...
pub struct ApiV1OnboardingPost403Response {
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl ApiV1OnboardingPost403Response {
    pub fn new() -> ApiV1OnboardingPost403Response {
        ApiV1OnboardingPost403Response { error: None }
    }
}
