...
pub struct DeploymentStatusManifestStatus {
    #[serde(rename = "state")]
    pub state: State,
...
impl DeploymentStatusManifestStatus {
    pub fn new(state: State) -> DeploymentStatusManifestStatus {
        DeploymentStatusManifestStatus { state, error: None }
    }
}
///
